...
switcher.addEventListener('click', function() {
    ...
    // describes how to switch themes in the app
...
consconst STARTING_POKER_CHIPS = 100; // points
const PLAYERS = 3;
const NO_OF_STARTER_CARDS = 2;
let gameHasEnded = false;
...
console.log("Game has ended: ", gameHasEnded);ole.log("Game has ended: ", gameHasEnded);